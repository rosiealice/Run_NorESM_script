...
outdir   = "lhs_params/"
nsamp    = 20  # number of ensemble members

# Parameter ranges (min, max)
param_ranges = {
    "fates_landuse_grazing_rate":  (0.5,  1.5),
    "fates_fire_cg_strikes": (0.5, 1.5),
    "fates_leaf_vcmax25top": (0.75, 1.5),
    "fates_leaf_slatop":  (0.75,  1.25),
    "fates_turnover_leaf_canopy": (0.75,  1.25)
}
