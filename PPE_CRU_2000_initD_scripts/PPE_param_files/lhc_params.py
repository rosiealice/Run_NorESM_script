...
paramsdir="/cluster/work/users/rosief/paramscratch/"
basefile = paramsdir+"fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci2_api1_c260130.nc"
outdir   = "lhs_params/"
nsamp    = 8  # number of ensemble members
...
param_ranges = {
   "fates_recruit_init_nocomp":{ 
        "all": (0.99,1.01),  # default for all PFTs
        13: (0.5, 3.0),        # specific range for PFT 1
        }, 
    "fates_allom_agb1": { 
        "all": (0.75,1.25),  # default for all PFTs
        1: (0.75, 1.25),        # specific range for PFT 1
        }, 
    ...
    "fates_leaf_vcmax25top": {  # PFT-specific ranges
        "all": (0.99,1.01),  # default for all PFTs
        1: (0.9, 1.25),        # specific range for PFT 1
         },
    }
