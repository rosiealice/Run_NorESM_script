...
param_ranges = {
    "fates_leaf_vcmax25top": (0.85, 1.15, 1),
    "fates_leaf_stomatal_slope_medlyn":  (0.75,  1.25 ,1),
    "fates_leaf_stomatal_intercept": (0.5,  1.5 ,1),
    "maximum_leaf_wetted_fraction": (0.9, 1.1, 0)
}
