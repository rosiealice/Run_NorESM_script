...
casename="i2000.$resolution.fatesnocomp.$noresmversion.CRUJRA.14hlmpft_LUCy2k_2000FSx16pft_15fpft.`date +"%Y-%m-%d"`"
...
#        cp /cluster/home/kjetisaa/Trendy_2025_scripts/SourceModFiles_S3rerun/BalanceCheckMod.F90 $workpath$casename/SourceMods/src.clm/
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        ...
        echo " fates_paramfile ='/cluster/work/users/rosief/paramscratch/fates_params_sci.1.88.6_api.42.0.0_14hlmpft_nor_sci3_api1_c260213_15pfts.nc'" >> $casedir/user_nl_clm
 ...
 #Land use changes 
        ...
        echo "fluh_timeseries='/cluster/shared/noresm/inputdata/LU_data_CMIP7/LUH3_states_transitions_management.timeseries_ne16_hist_steadystate_2000_2026-02-10_cdf5.nc'"  >> $casedir/user_nl_clm
        echo "flandusepftdat='/cluster/shared/noresmss/inputdata/LU_data_CMIP7/fates_landuse_pft_map_to_surfdata_ne16np4_260209_cdf5.nc'"  >> $casedir/user_nl_clm
    fi
fi
