...
#        cp /cluster/home/kjetisaa/Trendy_2025_scripts/SourceModFiles_S3rerun/BalanceCheckMod.F90 $workpath$casename/SourceMods/src.clm/
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        echo " fsurdat='/cluster/shared/noresm/inputdata/lnd/clm2/surfdata_esmf/ctsm5.4.0/surfdata_4x5_hist_2000_16pfts_c251022.nc'" >> $casedir/user_nl_clm        echo " fates_paramfile ='/cluster/work/users/rosief/paramscratch/grazing_ppe/ grazing_ppe$niter.cdl'" >> $casedir/user_nl_clm
 ...
 #Land use changes 
        ...
        echo "flandusepftdat='/cluster/shared/noresm/inputdata/LU_data_CMIP7/fates_landuse_pft_map_to_surfdata_4x5_hist_1850_16pfts_c241007_251009.nc
'"  >> $casedir/user_nl_clm
    fi
fi
