...
casename="i2000.$resolution.fatesnocomp.$noresmversion.CRUJRA.16hlmpft_noLUC_2000FSx78pft_16fpftxcrop.`date +"%Y-%m-%d"`"
...
#        cp /cluster/home/kjetisaa/Trendy_2025_scripts/SourceModFiles_S3rerun/BalanceCheckMod.F90 $workpath$casename/SourceMods/src.clm/
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        ...
        echo " fsurdat='/cluster/shared/noresm/inputdata/lnd/clm2/surfdata_esmf/ctsm5.4.0/surfdata_ne16np4.pg3_hist_2000_78pfts_c260209.nc' " >> $casedir/user_nl_clm      
