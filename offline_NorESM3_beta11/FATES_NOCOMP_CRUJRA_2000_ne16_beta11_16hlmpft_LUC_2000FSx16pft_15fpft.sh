...
casename="i2000.$resolution.fatesnocomp.$noresmversion.CRUJRA.16hlmpft_LUC_2000FSx16pft_15fpft.`date +"%Y-%m-%d"`"
...
#        cp /cluster/home/kjetisaa/Trendy_2025_scripts/SourceModFiles_S3rerun/BalanceCheckMod.F90 $workpath$casename/SourceMods/src.clm/
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        ...
        echo " fates_paramfile ='/cluster/work/users/rosief/paramscratch/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci3_api1_c260213_15pfts.nc'" >> $casedir/user_nl_clm
