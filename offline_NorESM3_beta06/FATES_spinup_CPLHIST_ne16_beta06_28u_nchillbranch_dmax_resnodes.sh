...
#NorESM dir
noresmrepo="noresm3_0_beta_06"
noresmversion="noresm3_0_beta06"


resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37, ne16pg3_tn14 
casename="i1850.$resolution.fatesnocomp.$noresmversion.CPLHIST_28u_nchill_branch_dmax_resnodes.`date +"%Y-%m-%d"`"
...
<         ./xmlchange NTASKS_GLC=-7
	...
	echo "finidat='/cluster/work/users/rosief/archive/i1850.ne16pg3_tn14.fatesnocomp.noresm3_0_beta06.CPLHIST_28u_nchill_branch_dmax.2025-11-20/rest/0091-01-01-00000/i1850.ne16pg3_tn14.fatesnocomp.noresm3_0_beta06.CPLHIST_28u_nchill_branch_dmax.2025-11-20.clm2.r.0091-01-01-00000.nc'" >> $casedir/user_nl_clm   
        ...
        echo "fluh_timeseries='/cluster/shared/noresm/inputdata/LU_data_CMIP7/LUH2_states_transitions_management.timeseries_ne16_hist_steadystate_1850_2025-11-06_cdf5.nc'"  >> $casedir/user_nl_clm
