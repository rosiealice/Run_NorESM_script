...
casename="i1850.$resolution.fatesnocomp.$noresmversion.CPLHIST_28n_nchill_branch_dmax.`date +"%Y-%m-%d"`"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo "fates_paramfile='/cluster/work/users/rosief/NorESM_3_0_beta01_ctsm_v9/cime/scripts/fates_params_api.noresm_42.0.0_14pft__noresm_v28n.nc'" >> $casedir/user_nl_clm
