...
casename="i2000.$resolution.fatesnocomp.$noresmversion.CPLHIST_soilc_c4g_auto_d2bl1_c4MS_int.`date +"%Y-%m-%d"`"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        ...
        echo "paramfile='/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/ctsm60_params.5.3.045_noresm_v14_c260106.nc >> $casedir/user_nl_clm
