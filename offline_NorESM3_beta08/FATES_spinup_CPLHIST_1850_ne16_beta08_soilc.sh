...
casename="i1850.$resolution.fatesnocomp.$noresmversion.CPLHIST_soilc.`date +"%Y-%m-%d"`"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        echo "fates_paramfile='/cluster/work/users/rosief/NorESM_3_0_beta01_ctsm_v9/cime/scripts/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci3_api1_c251218.nc'" >> $casedir/user_nl_clm
