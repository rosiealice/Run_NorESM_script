...
#NorESM dir
noresmrepo="noresm3_0_beta_08"
noresmversion="noresm3_0_beta08"


resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37, ne16pg3_tn14 
casename="i2000.$resolution.fatesnocomp.$noresmversion.CPLHIST_soilc_c4g_auto_d2bl1_c4MS_dmx.`date +"%Y-%m-%d"`"
echo "casename: $casename"
compset="2000_DATM%CPLHIST_CLM60%FATES_SICE_SOCN_SROF_SGLC_SWAV_SESP"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        echo "fates_paramfile='/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci9_api1_c251222.nc'" >> $casedir/user_nl_clm
        echo "paramfile='/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/ctsm60_params.5.3.045_noresm_v14_c260107.nc >> $casedir/user_nl_clm
        ...
        echo "fluh_timeseries='/cluster/shared/noresm/inputdata/LU_data_CMIP7/LUH2_states_transitions_management.timeseries_ne16_hist_steadystate_2000_2025-11-06_cdf5.nc'"  >> $casedir/user_nl_clm
        echo "flandusepftdat='/cluster/shared/noresm/inputdata/LU_data_CMIP7/fates_landuse_pft_map_to_surfdata_ne16np4_251106_cdf5.nc'"  >> $casedir/user_nl_clm
