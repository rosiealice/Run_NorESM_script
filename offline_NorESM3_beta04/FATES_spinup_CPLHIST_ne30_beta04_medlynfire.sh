...
casename="i1850.$resolution.fatesnocomp.$noresmversion.CPLHIST_medlynfire.`date +"%Y-%m-%d"`"
...
#        cp /cluster/home/kjetisaa/Trendy_2025_scripts/SourceModFiles_S3rerun/BalanceCheckMod.F90 $workpath$casename/SourceMods/src.clm/
        ...
        ./xmlchange DATM_CPLHIST_CASE=n1850.ne30_tn14.hybrid_fates-nocomp_spinup.3.0a02.20250415
        ./xmlchange DATM_CPLHIST_DIR=/cluster/shared/noresm/inputdata/cplhist/noresm3_0/n1850.ne30_tn14.hybrid_fates-nocomp_spinup.3.0a02.20250415
        ./xmlchange DATM_YR_START=1
        ./xmlchange DATM_YR_END=1
        ./xmlchange DATM_PRESNDEP=none
        ./xmlchange DATM_SKIP_RESTART_READ=FALSE
        ./xmlchange DATM_YR_ALIGN=1
        ./xmlchange DATM_YR_START_FILENAME=9999
