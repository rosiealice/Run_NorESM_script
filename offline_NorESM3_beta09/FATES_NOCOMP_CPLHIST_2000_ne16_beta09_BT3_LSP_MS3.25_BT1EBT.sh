...
#NorESM dir
noresmrepo="noresm3_0_beta_09"
noresmversion="noresm3_0_beta09"


resolution="ne16pg3_tn14" #f19_g17, ne30pg3_tn14, f45_f45_mg37, ne16pg3_tn14 
casename="i2000.$resolution.fatesnocomp.$noresmversion.CPLHIST.BT3_LSP_MS3.25_BT1EBT.`date +"%Y-%m-%d"`"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo " fates_paramfile ='/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci3_api1_c260123.nc'" >> $casedir/user_nl_clm
    fi
fi
