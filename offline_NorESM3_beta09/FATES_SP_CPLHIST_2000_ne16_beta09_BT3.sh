...
casename="i2000.$resolution.fatesSP.$noresmversion.CPLHIST.BT3.`date +"%Y-%m-%d"`"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo " use_fates_nocomp = .true." >> $casedir/user_nl_clm
 	echo " use_fates_fixed_biogeog = .true." >> $casedir/user_nl_clm
        echo " fates_paramfile ='/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci1_api1_BT3_c260108.nc'" >> $casedir/user_nl_clm
    fi
fi
