...
casename="i2000.$resolution.fatesnocomp.$noresmversion.CPLHIST.BT3_LSP_MS3.25.`date +"%Y-%m-%d"`"
...
DATM_CPLHIST_CASE=n1850.ne30_tn14.cplhist.3_0_a03b.20250606
	...
	echo " fates_paramfile ='/cluster/shared/noresm/inputdata/lnd/clm2/paramdata/fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci3_api1_c260120.nc'" >> $casedir/user_nl_clm
