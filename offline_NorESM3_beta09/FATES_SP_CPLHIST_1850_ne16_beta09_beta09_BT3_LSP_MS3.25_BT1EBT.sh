...
casename="i1850.$resolution.fatesSP.$noresmversion.CPLHIST__BT3_LSP_MS3.25_BT1EBT.`date +"%Y-%m-%d"`"
echo "casename: $casename"
compset="1850_DATM%CPLHIST_CLM60%FATES-SP_SICE_SOCN_SROF_SGLC_SWAV_SESP"
