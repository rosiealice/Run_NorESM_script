...
outdir   = "lhs_params/"
nsamp    = 4  # number of ensemble members
...
param_ranges = {
   "fates_leaf_stomatal_slope_medlyn":{ 
    ...
    "fates_allom_d2bl1": { 
        "all": (0.99,1.01),  # default for all PFTs
        1: (0.4, 0.65),        # specific range for PFT 1
        }, 
    "fates_allom_l2fr":  { 
        "all": (0.99,1.01),  # default for all PFTs
        1: (0.7, 0.8),        # specific range for PFT 1
        },
    "fates_leaf_slatop":  {
        "all": (0.99,1.01),  # default for all PFTs
        12: (1.0, 1.2),        # specific range for PFT 1
    },    
    "fates_leaf_vcmax25top": {  # PFT-specific ranges
        "all": (0.99,1.01),  # default for all PFTs
        5: (0.75, 1.25),        # specific range for PFT 1
        12: (1.0,1.2),      # increase c3g fluxes
        13: (0.75, 0.9),        # specific range for PFT 1
         },
    "fates_leaf_stomatal_intercept": {    
        "all": (0.99,1.01),  # default for all PFTs
        13: (0.1, 0.2),        # specific range for PFT 13
        }
    }
