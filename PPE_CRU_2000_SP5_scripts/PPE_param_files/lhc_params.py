...
basefile = paramsdir+"fates_params_sci.1.88.6_api.42.0.0_14pft_nor_sci3_api1_c260123.nc"
...
param_ranges = {
    "fates_leaf_vcmax25top": (0.75, 1.25, 1),
    "fates_leaf_stomatal_slope_medlyn":  (0.5,  1.1 ,1),
    "fates_leaf_stomatal_intercept": (0.5,  1.1 ,1),
    "maximum_leaf_wetted_fraction":(0.5,1.1 ,0),
    "liq_canopy_storage_scalar": (0.5,1.1 ,0)
}
